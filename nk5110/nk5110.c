...
const uint8_t font_table[][5] = {
    ...
    {0x41, 0x22, 0x1C, 0x22, 0x41}, // X (Index 56)
    {0x07, 0x08, 0x70, 0x08, 0x07}, {0x41, 0x61, 0x51, 0x49, 0x47},
    // 91 '[' -> 96 '`'
    {0x00, 0x7F, 0x41, 0x41, 0x00}, // [ (Square Bracket) 
    {0x02, 0x04, 0x08, 0x10, 0x20}, // \ (Backslash)
    {0x00, 0x41, 0x41, 0x7F, 0x00}, // ] (Square Bracket)
    {0x04, 0x02, 0x01, 0x02, 0x04}, // ^ (Caret)
    {0x40, 0x40, 0x40, 0x40, 0x40}, // _ (Underscore)
    {0x00, 0x01, 0x02, 0x04, 0x00}, // ` (Grave Accent)
    ...
    {0x00, 0x40, 0x20, 0x40, 0x20}, // ~ (Tilde)
};
